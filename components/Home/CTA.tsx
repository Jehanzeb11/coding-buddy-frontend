    ...
    <section className="py-20 px-4">
      <div className="container mx-auto text-center max-w-4xl">
        ...
        <div className="w-full flex justify-center">
          ...
          <Link href="/register">
            <Button size="lg" className="flex items-center text-lg px-8 py-6 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white border-0 transition-all duration-300 shadow-lg hover:shadow-xl group">
