...
const Hero: React.FC = () => {
  return (
    <section className="pt-44 pb-28 px-4 bg-linear-to-br from-indigo-50 via-purple-50 to-pink-50 dark:from-[#071024] dark:via-[#2b0b3a] dark:to-[#3b0f2f]">
      <div className="container mx-auto text-center max-w-4xl">
        <h1 className="text-4xl md:text-6xl font-bold mb-2 bg-linear-to-r from-indigo-500 via-purple-500 to-pink-500 bg-clip-text text-transparent leading-20 dark:from-[#8b5cf6] dark:via-[#7c3aed] dark:to-[#ec4899]">
