...
const Hero: React.FC<{ observerRef: React.RefObject<HTMLDivElement | null> }> = ({ observerRef }) => {
  return (
  <section ref={observerRef} className="py-20 px-4 bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 dark:from-[#071024] dark:via-[#2b0b3a] dark:to-[#3b0f2f] opacity-0 translate-y-8 transition-all duration-700 ease-out">
