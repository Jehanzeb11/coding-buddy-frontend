...
const Features: React.FC<{ featuresRef: React.RefObject<HTMLDivElement | null> }> = ({ featuresRef }) => {
  return (
  <section ref={featuresRef} className="py-20 px-4 bg-gradient-to-br bg-muted/50 opacity-0 translate-y-8 transition-all duration-[2s] ease-in-out dark:from-[#050617] dark:via-[#0b0b1f] dark:to-[#16061f]">
        <div className="container mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 bg-clip-text text-transparent dark:from-[#9b7cf8] dark:via-[#7c3aed] dark:to-[#ff7ab6]">Powerful Features</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <Card className="text-center border-0 shadow-xl hover:shadow-2xl transition-all duration-300 bg-gradient-to-br from-white via-gray-50 to-indigo-50 dark:bg-gradient-to-br dark:from-[#081227] dark:via-[#0b1130] dark:to-[#081227] dark:border dark:border-neutral-800 dark:shadow-[0_10px_30px_rgba(124,58,237,0.14)] group hover:scale-105 hover:-translate-y-2">
              <CardHeader>
                <div className="mx-auto w-12 h-12 bg-gradient-to-r from-indigo-600 to-purple-600 rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300 shadow-lg dark:from-[#7c3aed] dark:to-[#8b5cf6] dark:shadow-[0_6px_20px_rgba(140,92,246,0.28)]">
            ...
            <Card className="text-center border-0 shadow-lg hover:shadow-2xl transition-all duration-300 bg-gradient-to-br from-white via-gray-50 to-indigo-50 dark:bg-gradient-to-br dark:from-[#081227] dark:via-[#0b1130] dark:to-[#081227] dark:border dark:border-neutral-800 dark:shadow-[0_8px_26px_rgba(124,58,237,0.12)] group hover:scale-105 hover:-translate-y-2">
              <CardHeader>
                <div className="mx-auto w-12 h-12 bg-gradient-to-r from-indigo-600 to-purple-600 rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300 dark:from-[#7c3aed] dark:to-[#8b5cf6] dark:shadow-[0_6px_18px_rgba(124,58,237,0.22)]">
